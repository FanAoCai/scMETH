...
sys.path.insert(0, "../../")
import scgepop as scg
from scgepop import scbank
...
parser.add_argument(
    ...
    type=str,
    # required=True,
    default="/mnt/afan/scGEPOP/data/cellxgene/dataset/African American",
    help="Directory containing AnnData objects",
)
parser.add_argument(
    "--output_dir",
    type=str,
    default="/mnt/afan/scGEPOP/data/cellxgene/scb_file/African American",
