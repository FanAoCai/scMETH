...
class MoEBlock(Block):
    ...
    def __init__(self, dim, num_heads, num_experts, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.moe = MoE(dim, num_experts=num_experts)
        
    def forward(self, x):
        x = x + self.drop_path(self.attn(self.norm1(x)))
        output, loss_moe = self.moe(self.norm2(x))
